...
pub fn rollDie() i8 {
    ...
    const dice1 = random.intRangeAtMost(i8, 1, 6);
    const dice2 = random.intRangeAtMost(i8, 1, 6);
    const dice3 = random.intRangeAtMost(i8, 1, 6);
    const dice4 = random.intRangeAtMost(i8, 1, 6);
